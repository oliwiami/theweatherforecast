...
const App=() => {
  ...
  const [noData, setNoData] = useState('Search for location')
  ...
  const getWeather = async(location) =>{
    ...
    try{
      ...
      setNoData("An Error has occured :(")    
    }
  }
  ...
  return (
    <div className="lg:flex items-center justify-center w-screen h-screen py-10">
      <div className="lg:flex w-3/4 min-h-full rounded-3xl shadow-lg m-auto bg-gray-100">
        ...
        <div className="form-container">
          ...
          <div className="lg:flex p-2 text-gray-100 bg-gray-600 bg-opacity-30 rounded-lg">
          ...
          <div className="lg:flex lg:flex-col items-center justify-center h-full">
            <h1 className="text-white text-4xl"> Check your weather today!</h1>
            <hr className="h-1 bg-white w-1/4 rounded-full my-5"/>
            <form noValidate onSubmit={handleSubmit} className="lg:flex justify-center w-full">
              <input type="text" 
        ...
        <div className="lg:w-2/4 p-5">             
                <div className="lg:flex lg:flex-col my-10">
                  ...
                  <div className="container p-4 lg:flex items-center justify-center h-1 mb-auto">
                    <h1 className="text-gray-300 text-4xl font-bp;d uppercase">{noData}</h1>
                  </div> :
                   <>
                    <h1 className="text-5xl text-gray-800 mt-auto mb-4">Today</h1>
                    <DetailCard weather_icon={weatherIcon} data={weatherData} />
                    <h1 className="text-3xl text-gray-600 mb-4 mt-10">Forecast for {city}</h1>
